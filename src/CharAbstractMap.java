...
public abstract class CharAbstractMap<V>  {
    /**
     * Sole constructor.  (For invocation by subclass constructors, typically
     * implicit.)
     */
    protected CharAbstractMap() {
    }
    ...
    public boolean containsValue(Object value) {
        Iterator<SimpleEntry<V>> i = entrySet().iterator();
        if (value==null) {
            while (i.hasNext()) {
                SimpleEntry<V> e = i.next();
                if (e.getValue()==null)
                    return true;
            }
        } else {
    ...
    public V get(Object key) {
        ...
        if (key==null) {
            while (i.hasNext()) {
                SimpleEntry<V> e = i.next();
                if (e.getKey()==Character.MAX_VALUE)
                    return e.getValue();
            }
        } else {
            while (i.hasNext()) {
    ...
    public V remove(char key) {
        Iterator<SimpleEntry<V>> i = entrySet().iterator();
        SimpleEntry<V> correctEntry = null;
     ...
     *}</pre>
     */
    transient Set<Character> keySet;
        ...
        if (ks == null) {
            ks = new AbstractSet<>() {
                ...
                public Iterator<Character> iterator() {
                    return new Iterator<>() {
                        private Iterator<SimpleEntry<V>> i = entrySet().iterator();
                ...
                @Override
                public int size() {
                    return CharAbstractMap.this.size();
                }
                @Override
                public boolean isEmpty() {
                    return CharAbstractMap.this.isEmpty();
                }
                @Override
                public void clear() {
                    CharAbstractMap.this.clear();
                }
                @Override
                public boolean contains(Object k) {
                    return CharAbstractMap.this.containsKey((Character) k);
                }
            };
            keySet = ks;
        }
        ...
        if (vals == null) {
            vals = new AbstractCollection<V>() {
                ...
                public boolean contains(Object v) {
                    return CharAbstractMap.this.containsValue(v);
                }
            };
            values = vals;
        }
    ...
    public abstract Set<SimpleEntry<V>> entrySet();
    ...
    public int hashCode() {
        int h = 0;
        for (SimpleEntry<V> entry : entrySet())
            h += entry.hashCode();
        return h;
    }
    ...
    protected Object clone() throws CloneNotSupportedException {
        CharAbstractMap<?> result = (CharAbstractMap<?>)super.clone();
        result.keySet = null;
        result.values = null;
        return result;
    }
            ...
            implements java.io.Serializable
    {
         ...
         */
        public SimpleEntry(char key, V value) {
            this.key   = key;
            this.value = value;
        }
            ...
            implements java.io.Serializable
    {
         ...
         * @param value the value represented by this entry
         */
        public SimpleImmutableEntry(char key, V value) {
            this.key   = key;
            this.value = value;
        }
